...
public final class DConcurrentServerGrpc {
  ...
  private static io.grpc.MethodDescriptor<util.dconcurrent.core.DStatus,
      DBytes> getResetStatMethodHelper() {
    io.grpc.MethodDescriptor<util.dconcurrent.core.DStatus, DBytes> getResetStatMethod;
  ...
  public static final io.grpc.MethodDescriptor<DBytes,
      util.dconcurrent.core.DStatus> METHOD_GET_STAT = getGetStatMethodHelper();

  private static volatile io.grpc.MethodDescriptor<DBytes,
      util.dconcurrent.core.DStatus> getGetStatMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<DBytes,
      util.dconcurrent.core.DStatus> getGetStatMethod() {
    return getGetStatMethodHelper();
  }

  private static io.grpc.MethodDescriptor<DBytes,
      util.dconcurrent.core.DStatus> getGetStatMethodHelper() {
    io.grpc.MethodDescriptor<DBytes, util.dconcurrent.core.DStatus> getGetStatMethod;
  ...
  public static final io.grpc.MethodDescriptor<util.dconcurrent.core.DObject,
      DBytes> METHOD_RUN = getRunMethodHelper();
  ...
  private static io.grpc.MethodDescriptor<util.dconcurrent.core.DObject,
      DBytes> getRunMethodHelper() {
    io.grpc.MethodDescriptor<util.dconcurrent.core.DObject, DBytes> getRunMethod;
  ...
  public static final io.grpc.MethodDescriptor<util.dconcurrent.core.DObject,
      DBytes> METHOD_CALL = getCallMethodHelper();

  private static volatile io.grpc.MethodDescriptor<util.dconcurrent.core.DObject,
      DBytes> getCallMethod;
  ...
  private static io.grpc.MethodDescriptor<util.dconcurrent.core.DObject,
      DBytes> getCallMethodHelper() {
    io.grpc.MethodDescriptor<util.dconcurrent.core.DObject, DBytes> getCallMethod;
  ...
  public static abstract class DConcurrentServerImplBase implements io.grpc.BindableService {
    ...
    public void resetStat(util.dconcurrent.core.DStatus request,
        io.grpc.stub.StreamObserver<DBytes> responseObserver) {
